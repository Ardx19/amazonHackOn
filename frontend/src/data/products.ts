...
// Category → fallback product image for Float deal items (API has no image_url).
// Replace these CDN URLs with real Amazon.in m.media-amazon.com image URLs when access is available.
export const CATEGORY_IMAGE_MAP: Record<string, string> = {
  footwear:     'https://cdn.dummyjson.com/products/images/mens-shoes/Sneakers%20Shoes/thumbnail.png',
  electronics:  'https://cdn.dummyjson.com/products/images/smartphones/iPhone%205s/thumbnail.png',
  clothing:     'https://cdn.dummyjson.com/products/images/mens-shirts/Blue%20&%20Black%20Check%20Shirt/thumbnail.png',
  home_goods:   'https://cdn.dummyjson.com/products/images/kitchen-accessories/Bamboo%20Spatula/thumbnail.png',
  baby_products:'https://cdn.dummyjson.com/products/images/sports-accessories/Basketball/thumbnail.png',
  default:      'https://cdn.dummyjson.com/products/images/mens-shoes/Sneakers%20Shoes/thumbnail.png',
};
